...
module Phlex::Rails::Helpers
	...
	# Helpers included into Phlex component via `include Phlex::Rails::Helpers`
	include ActionCableMetaTag
	include ActionName
	include AssetPath
	include AssetURL
	include AudioPath
	include AudioTag
	include AudioURL
	include AutoDiscoveryLinkTag
	include BuildTagValues
	include ButtonTag
	include ButtonTo
	include Checkbox
	include CheckboxTag
	...
	include ColorField
	include ColorFieldTag
	include ComputeAssetExtname
	include ComputeAssetHost
	include ComputeAssetPath
	include ContentFor
	include ContentTag
	include ControllerName
	include ControllerPath
	include CSPMetaTag
	include CSRFMetaTags
	include CurrentCycle
	include CurrentPage
	include Cycle
	include DateField
	include DateFieldTag
	include DateSelect
	include DateTimeField
	include DateTimeFieldTag
	include DateTimeLocalField
	include DateTimeLocalFieldTag
	include DateTimeSelect
	include Debug
	include DefaultURLOptions
	include DistanceOfTimeInWords
	include DistanceOfTimeInWordsToNow
	include DOMClass
	include DOMID
	include EmailField
	include EmailFieldTag
	include ErrorMessage
	include ErrorWrapping
	include EscapeOnce
	include Excerpt
	include FaviconLinkTag
	include FieldID
	include FieldName
	include Fields
	include FieldSetTag
	...
	include GroupedOptionsForSelect
	include HiddenField
	include HiddenFieldTag
	include Highlight
	include ImagePath
	include ImageSubmitTag
	include ImageTag
	include ImageURL
	include JavaScriptImportModuleTag
	include JavaScriptImportMapTags
	include JavaScriptIncludeTag
	include JavaScriptPath
	include JavaScriptTag
	include JavaScriptURL
	include L
	include Label
	include LabelTag
	include LinkTo
	include LinkIf
	include LinkToUnless
	include LinkToUnlessCurrent
	include Localize
	include MailTo
	include MonthField
	include MonthFieldTag
	include NumberField
	include NumberFieldTag
	include NumberToCurrency
	include NumberToHuman
	include NumberToHumanSize
	include NumberToPercentage
	include NumberToPhone
	include NumberWithDelimiter
	include NumberWithPrecision
	include Object
	include OptionGroupsFromCollectionForSelect
	include OptionsForSelect
	include OptionsFromCollectionForSelect
	include PasswordField
	include PasswordFieldTag
	include PathToAsset
	include PathToAudio
	include PathToFont
	include PathToImage
	include PathToJavaScript
	include PathToStyleSheet
	include PathToVideo
	include PhoneField
	include PhoneFieldTag
	include Pluralize
	include PreloadLinkTag
	include PhoneTo
	include Provide
	include PublicComputeAssetPath
	include RadioButton
	include RadioButtonTag
	include RangeField
	include RangeFieldTag
	include ResetCycle
	...
	include SelectDay
	include SelectHour
	include SelectMinute
	include SelectMonth
	include SelectSecond
	include SelectTime
	include SelectYear
	include SimpleFormat
	include SMSTo
	include StripLinks
	include StripTags
	include StyleSheetLinkTag
	include StyleSheetPath
	include StyleSheetURL
	include SubmitTag
	include T
	include ClassMethods
	include TelephoneField
	include TelephoneFieldTag
	include TextArea
	include TextAreaTag
	include TextField
	include TextFieldTag
	include TimeAgoInWords
	include TimeField
	include TimeFieldTag
	include TimeSelect
	include TimeTag
	include TimeZoneOptionsForSelect
	include TimeZoneSelect
	include TokenList
	include Translate
	include Truncate
	include TurboFrameTag
	include TurboIncludeTags
	include TurboStreamFrom
	include TurboStream
	include URLField
	include URLFieldTag
	include URLFor
	...
	include URLToFont
	include URLToImage
	include URLToJavaScript
	include URLToStyleSheet
	include URLToVideo
	include UTF8EnforcerTag
	include VideoPath
	include VideoTag
	include VideoURL
	include WeekField
	include WeekFieldTag
	include WeekdayOptionsForSelect
	include WeekdaySelect
	include WithOutputBuffer
	include WordWrap
end
